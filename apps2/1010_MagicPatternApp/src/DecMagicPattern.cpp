...
DecMagicPattern::DecMagicPattern( std::string option ) {
    ...
    container->_( Stack() 
        ...
        ._( Pages() 
            ...
            ._( Image( "magic_pattern/Background01-01.png" ).align( ALIGN_CENTER ).border( false ).size( -1, -1) )
            ._( Image( "magic_pattern/Background02-01.png" ).align( ALIGN_CENTER ).border( false ).size( -1, -1) )
            ._( Image( "magic_pattern/Background03-01.png" ).align( ALIGN_CENTER ).border( false ).size( -1, -1) )
            ._( Image( "magic_pattern/Background04-01.png" ).align( ALIGN_CENTER ).border( false ).size( -1, -1) )
        )   
        ._( Image( "magic_pattern/Body-01.png" ).ref( (DecWidget **)&_pHuman ).align( ALIGN_CENTER ).background( false ).border( false ).size( -1, -1) )
        ._( Image( "magic_pattern/Pant-01.png" ).align( ALIGN_CENTER ).border( false ).size( -1, -1).background(false) )
        ._( Stack().border(false).background(false)
            ._( Pages() 
                ...
                ._( Image( "magic_pattern/Sleeve00-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve01-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve02-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve03-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve04-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve05-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve06-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve07-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve08-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve09-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve10-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve11-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Sleeve12-01.png" ).border( false ).background( false ).size( -1, -1 ) )
            )
            ._( Pages() 
                .size( -1, -1 )
                .align( ALIGN_CENTER )
                ...
                ._( Image( "magic_pattern/Shirt000-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt001-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt002-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt003-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt004-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt010-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt011-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt012-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt013-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt014-01.png" ).border( false ).background( false ).size( -1, -1 ) )                    
                ._( Image( "magic_pattern/Shirt100-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt101-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt102-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt103-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt104-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt110-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt111-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt112-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt113-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt114-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt200-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt201-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt202-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt203-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt204-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt210-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt211-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt212-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt213-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ._( Image( "magic_pattern/Shirt214-01.png" ).border( false ).background( false ).size( -1, -1 ) )                                                   
            ) 
            ._( Pages() 
                .size( -1, -1 )
                .align( ALIGN_CENTER )
                ...
                ._( Pages() 
                    ...
                    ._( Image( "magic_pattern/Base000-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base001-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base002-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base100-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base101-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base102-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base200-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base201-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base202-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ...
                ._( Pages() 
                    ...
                    ._( Image( "magic_pattern/Base010-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base011-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base012-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base110-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base111-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base112-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base210-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base211-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Base212-01.png" ).border( false ).background( false ).size( -1, -1 ) )
            ...
            ._( Pages() 
                ...
                ._( Pages() 
                    ...
                    ._( Image( "magic_pattern/Collar00-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Collar01-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Collar02-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Collar03-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Collar04-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Collar05-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                    ._( Image( "magic_pattern/Collar06-01.png" ).border( false ).background( false ).size( -1, -1 ) )
                ) 
                ._( Pages() 
                    .size( -1, -1 )
                    .align( ALIGN_CENTER )
            ...
            ._( Pages() 
                ...
                ._( Image( "magic_pattern/Hair01-01.png" ).background(false).align( ALIGN_CENTER ).border( false ).size( -1, -1) )
                ._( Image( "magic_pattern/Hair02-01.png" ).background(false).align( ALIGN_CENTER ).border( false ).size( -1, -1) )
                ._( Image( "magic_pattern/Hair03-01.png" ).background(false).align( ALIGN_CENTER ).border( false ).size( -1, -1) )
                ._( Image( "magic_pattern/Hair04-01.png" ).background(false).align( ALIGN_CENTER ).border( false ).size( -1, -1) )
                ._( Image( "magic_pattern/Hair05-01.png" ).background(false).align( ALIGN_CENTER ).border( false ).size( -1, -1) )
            )              
            ._( Image( "magic_pattern/Hand-01.png" ).ref( (DecWidget **)&_pHand ).align( ALIGN_CENTER ).border( false ).size( -1, -1).background(false) )
        ...
        Column()
            ...
            ._( Row()
                ...
                ._( Button( "Generate Product List", 0, [=](DecButton &btn) {
                    ...
                    std::ofstream f( "_files/magicpattern_product.csv");
                    ...
                    while( true ) {
                        ...
                        int body = _generateLength * 10 + _generateType * 5 + _generateNeck;
                        setBody( body );
                        setHem( _generateHem );
                        ...
                        sprintf( szMaterial, "<img class=""aligncenter wp-image-5070"" src=""https://magicpattern.co/wp-content/uploads/2022/08/material%02i.png"" alt=""วัสดุที่ใช้"" width=""360"" height=""360"" />\\n", n ); 
...
<br>" );
                        ...
                        for( int i=0; i<10; i++ ) {
                            ...
                            if( std::filesystem::exists( szPNGFN ) ) {
                                sprintf( szPNGFN, "<img class=\"\"alignnone size-full wp-image-6621\"\" src=\"\"https://magicpattern.co/_export_png2/%04i-%04i.png\"\" alt=\"\"\"\" />", _generateCount, i );
                        ...
                        sprintf( szx, ",\"simple, downloadable\",%s,Magic Pattern #%04i,1,0,visible,\"%s\",\"%s\",,,taxable,,1,,,0,0,,,,,0,,,400,Magic Pattern,MagicPattern,,https://magicpattern.co/wp-content/uploads/2022/07/%04i-%s.png,-1,-1,,,,,,,0,MagicPattern-%04i,MagicPattern-%04i.zip,https://magicpattern.co/F1n=411e/%04i.zip,,,\n",
                            _sku, _generateCount, szShort, szLong, _generateCount, _sku, _generateCount, _generateCount, _generateCount
                        ); 
...
void DecMagicPattern::update() {
    ...
    if( _generateProduct ) {
        if( _generateFrame % 10 == 0 ) {
            ...
            char sz[128];
            sprintf( sz, "_images/%04i-%s.png", _productCode, _sku );
            _pMainImage->capture( sz, false, true );

        ...
        Pages()
            ...
            ._( Scroller( SCROLL_HORIZONTAL ) 
                ...
                ._(Row()
                    ...
                    ._(Button( "เดรสเหนือเข่า", 0, [=](DecButton &btn) { this->setShirtLength( 3 ); }  ))
                    ._(Button( "เดรสคลุมเข่า", 0, [=](DecButton &btn) { this->setShirtLength( 4 ); }  ))
                ) 
            )  
            ._( Scroller( SCROLL_HORIZONTAL ) 
                .size( -1, 0 )              
                ._(Row()
                    ...
                    ._(Button( "คอสี่เหลี่ยมแคบ", 0, [=](DecButton &btn) { this->setShirtNeck( 5 ); } ))
                    ._(Button( "คอคว้านแคบ", 0, [=](DecButton &btn) { this->setShirtNeck( 6 ); } ))
                    ._(Button( "คอหยดน้ำมีโบว์", 0, [=](DecButton &btn) { this->setShirtNeck( 7 ); } ))
                )  
            )               
...
void DecMPPanel::updateShirtBody() {
    ...
    _shirt_body_index = (_shirt_length * 15) + (_shirt_type * 8) + _shirt_neck;    
    if( _pMagicPattern ) {

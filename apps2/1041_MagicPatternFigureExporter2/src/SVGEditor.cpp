...
DecSVGEditor::DecSVGEditor() {
    ...
    for( int l=0; l<5; l++ ) {
        for( int i=0; i<2; i++ ) {
            for( int p=0; p<11; p++ ) {
                _vPocketTreeItems[l][i][p] = NULL;
            }
            for( int c=0; c<5; c++ ) {
                _vPocketCoverTreeItems[l][i][c] = NULL;
            }
        }
    }
    ...
    _(SVGDomEditor("_magicpattern/dress-01.svg").ref((DecWidget**)&pSVGDomEditor).cache(true));
    _( FileDialogBox()
        ...
        ._( Scroller( SCROLL_VERTICAL )
            ._( Column()
                ...
                ._( Column()
                    ...
                    ._(Row().size( -1, 0).border(false).gap( 10 )
                        ._(Column().size( -1, 0).border(false)
                            ._( Text( "ฝากระเป๋าบนขวา" ).margin_top( 5 ) )
                            ._( ComboBox()
                                .ref( (DecWidget **)&_pComboPocketCover[0][0] )
                                .size( -1, 32 )
                                .border( true )
                                .onValueChanged( [=](DecWidget &widget) {
                                    showPocketCover( 0, 0, widget.value() );
                                })
                            ) 
                        )         
                        ._(Column().size( -1, 0).border(false)
                            ._( Text( "ฝากระเป๋าบนซ้าย" ).margin_top( 5 ) )
                            ._( ComboBox()
                                .ref( (DecWidget **)&_pComboPocketCover[0][1] )
                                .size( -1, 32 )
                                .border( true )
                                .onValueChanged( [=](DecWidget &widget) {
                                    showPocketCover( 0, 1, widget.value() );
                                })
                            ) 
                        )         
                    )
                    ._(Row().size( -1, 0).border(false).gap( 10 )
                        ._(Column().size( -1, 0).border(false)
                            ._( Text( "กระเป๋าบนขวา" ).margin_top( 5 ) )
                            ._( ComboBox()
                                .ref( (DecWidget **)&_pComboPocket[0][0] )
                                .size( -1, 32 )
                                .border( true )
                                .onValueChanged( [=](DecWidget &widget) {
                                    showPocket( 0, 0, widget.value() );
                                })
                            ) 
                        )
                        ._(Column().size( -1, 0).border(false)
                            ._( Text( "กระเป๋าบนซ้าย" ).margin_top( 5 ) )
                            ._( ComboBox()
                                .ref( (DecWidget **)&_pComboPocket[0][1] )
                                .size( -1, 32 )
                                .border( true )
                                .onValueChanged( [=](DecWidget &widget) {
                                    showPocket( 0, 1, widget.value() );
                                })
                            ) 
                        )
                    )
                    ._(Row().size( -1, 0).border(false).gap( 10 )
                        ._(Column().size( -1, 0).border(false)
                            ._( Text( "ฝากระเป๋าล่างขวา" ).margin_top( 5 ) )
                            ._( ComboBox()
                                .ref( (DecWidget **)&_pComboPocketCover[1][0] )
                                .size( -1, 32 )
                                .border( true )
                                .onValueChanged( [=](DecWidget &widget) {
                                    showPocketCover( 1, 0, widget.value() );
                                })
                            ) 
                        )         
                        ._(Column().size( -1, 0).border(false)
                            ._( Text( "ฝากระเป๋าล่างซ้าย" ).margin_top( 5 ) )
                            ._( ComboBox()
                                .ref( (DecWidget **)&_pComboPocketCover[1][1] )
                                .size( -1, 32 )
                                .border( true )
                                .onValueChanged( [=](DecWidget &widget) {
                                    showPocketCover( 1, 1, widget.value() );
                                })
                            ) 
                        )         
                    )
                    ._(Row().size( -1, 0).border(false).gap( 10 )
                        ._(Column().size( -1, 0).border(false)
                            ._( Text( "กระเป๋าล่างขวา" ).margin_top( 5 ) )
                            ._( ComboBox()
                                .ref( (DecWidget **)&_pComboPocket[1][0] )
                                .size( -1, 32 )
                                .border( true )
                                .onValueChanged( [=](DecWidget &widget) {
                                    showPocket( 1, 0, widget.value() );
                                })
                            ) 
                        )
                        ._(Column().size( -1, 0).border(false)
                            ._( Text( "กระเป๋าล่างซ้าย" ).margin_top( 5 ) )
                            ._( ComboBox()
                                .ref( (DecWidget **)&_pComboPocket[1][1] )
                                .size( -1, 32 )
                                .border( true )
                                .onValueChanged( [=](DecWidget &widget) {
                                    showPocket( 1, 1, widget.value() );
                                })
                            ) 
                        )
                    )
                    ...
                    ._(Row().size( -1, 0 ).border( false ).gap( 10 )
                        ._(Button( "Pocket", 0, [=](DecButton &btn) {
                            exportPocket();
                        }))    
                        ._(Button( "PocketCover", 0, [=](DecButton &btn) {
                            exportPocketCover();
                        }))  
                    )                    
                    ._(Row().size( -1, 0 ).border( false ).gap( 10 )
...
void DecSVGEditor::setBG( int bg ) {
    _pBGComboBox->select_comboboxItem( bg );
}

void DecSVGEditor::setLength( int l, bool show ) {
    if( show ) {
        _pBlouseLengthComboBox->select_comboboxItem( l );
    }
    else {
...
void DecSVGEditor::showPocket( int level, int side, int type ) {
    _nPocketType[level][side] = type;
    //_nPocketCoverType[level][side] = type;
    SkDebugf( "ShowPaocket %i %i %i\n", level, side, type );

    if( level == 0 ) {
        for( int t=0; t<11; t++ ) {
            DecTreeItem *pItem = _vPocketTreeItems[level][side][t];
            if( !pItem )
                continue;     
            if( t == type ) {
                SkDebugf( "Level: %i, Side: %i, Type: %i\n", level, side, type );
                setNodeVisibility( pItem, true );
            }
            else {
                setNodeVisibility( pItem, false );
        ...
        int ll = _nCurrentBlouseLength + 1;
        if( ll == 5 ) {
            ll = 4;
        }
        SkDebugf( "Length: %i %i\n", _nCurrentBlouseLength, ll );

        for( int l=1; l<5; l++ ) {
            for( int t=0; t<11; t++ ) {
                DecTreeItem *pItem = _vPocketTreeItems[l][side][t];
                if( !pItem )
                    continue;     
                if( l == ll && t == type ) {
                    SkDebugf( "Level: %i, Side: %i, Type: %i\n", l, side, type );
...
void DecSVGEditor::showPocketCover( int level, int side, int type ) {
    _nPocketCoverType[level][side] = type;
    //_nPocketCoverType[level][side] = type;
    SkDebugf( "ShowPaocketCover %i %i %i\n", level, side, type );

    if( level == 0 ) {
        for( int t=0; t<5; t++ ) {
            DecTreeItem *pItem = _vPocketCoverTreeItems[level][side][t];
            if( !pItem )
                continue;     
            if( t == type ) {
                SkDebugf( "Level: %i, Side: %i, Type: %i\n", level, side, type );
        ...
        for( int l=1; l<5; l++ ) {
            for( int t=0; t<5; t++ ) {
                DecTreeItem *pItem = _vPocketCoverTreeItems[l][side][t];
                if( !pItem )
                    continue;     
                if( l == ll && t == type ) {
                    SkDebugf( "Level: %i, Side: %i, Type: %i\n", l, side, type );
...
void DecSVGEditor::setHair( int bg ) {
    _pHairComboBox->select_comboboxItem( bg );
}
...
void DecSVGEditor::setType( int t ) {
    SkDebugf( "SetType: %i\n", t );
    _pBlouseTypeComboBox->select_comboboxItem( t );
}
...
void DecSVGEditor::setNeck( int n ) {
    _pBlouseNeckComboBox->select_comboboxItem( n );
}

void DecSVGEditor::showBlouseNeck( int bg ) {
    _nCurrentBlouseNeck = bg;
    if( _nCurrentBlouseNeck == 7 ) { // คอหยดน้ำมีโบว์
        if( _nCurrentBlouseType != 0 ) {
            setType( 0 );
        }
    }
...
void DecSVGEditor::setCollar( int c ) {
    _pCollarComboBox->select_comboboxItem( c );
}

void DecSVGEditor::showCollar( int c ) {
    _nCurrentCollar = c;
    if( _nCurrentCollar >= 1 && _nCurrentCollar <= 5 ) {
        if( _nCurrentBlouseNeck == 1 ) {
            setNeck( 0 );
        }
    }
    else if( _nCurrentCollar == 6 ) {
        if( _nCurrentBlouseNeck == 0 ) {
            setNeck( 1 );
        }
    }
...
void DecSVGEditor::setHem( int h ) {
    _pBlouseHemComboBox->select_comboboxItem( h );
}
...
void DecSVGEditor::setBody( int bg ) {
    _pBodyComboBox->select_comboboxItem( bg );
}
...
void DecSVGEditor::setPant( int bg ) {
    _pPantComboBox->select_comboboxItem( bg );
}
...
void DecSVGEditor::setHand( int bg ) {
    _pHandComboBox->select_comboboxItem( bg );
}
...
void DecSVGEditor::setSleeve( int sl ) {
    _pSleeveComboBox->select_comboboxItem( sl );
}
...
void DecSVGEditor::showBlouseLength( int sl ) {
    ...
    if( _nCurrentBlouseLength > 2 ) {
        if( _nCurrentBlouseHem > 0 ) {
            setHem( 0 );
        }
    }
    showPocket( 1, 0, _nPocketType[1][0] );
    showPocket( 1, 1, _nPocketType[1][1] );

    showPocketCover( 1, 0, _nPocketCoverType[1][0] );
    showPocketCover( 1, 1, _nPocketCoverType[1][1] );
...
void DecSVGEditor::addSubNodeToTreeItem(DecTreeItem& treeNode, SkSVGNode* node, int deep, std::string parentNodeName ) {
    ...
    if( deep == 2 ) {
        if( nodeName == "หุ่น" ) {
            ...
            _pBodyComboBox->select_comboboxItem( 1 );          
        }
            ...
            _pPantComboBox->select_comboboxItem( 1 );          
        }             
            ...
            setNodeVisibility( new_node, false );
        }
    }
    if( deep == 3 ) {     
        if( starts_with( parentNodeName, "กระเป๋า" ) ) {
            ...
            if( _nPocket == 0 ) {
                for( int r=0; r<2; r++ ) {
                    for( int s=0; s<2; s++ ) {
                        _pComboPocket[r][s]->_( ComboBoxItem( "0" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "ทรงเหลี่ยม" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "ทรงโค้ง" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "ทรงหกเหลี่ยม" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "ทรงแหลม" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "จีบ box เหลี่ยม" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "จีบ box โค้ง" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "จีบ box หกเหลี่ยม" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "จีบคว่ำเหลี่ยม" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "จีบคว่ำโค้ง" )); 
                        _pComboPocket[r][s]->_( ComboBoxItem( "จีบคว่ำหกเหลี่ยม" )); 
    
                        _pComboPocket[r][s]->select_comboboxItem( 0 ); 
                    }
                }
            }
            _nPocket++;
            ...
            if( pocket_level != -1 && pocket_side != -1 && pocket_type != -1 ) {
                ...
                _vPocketTreeItems[pocket_level][pocket_side][pocket_type] = new_node;
            }
        }
            ...
            if( _nPocketCover == 0 ) {
                for( int r=0; r<2; r++ ) {
                    for( int s=0; s<2; s++ ) {
                        _pComboPocketCover[r][s]->_( ComboBoxItem( "0" )); 
                        _pComboPocketCover[r][s]->_( ComboBoxItem( "เหลี่ยม" )); 
                        _pComboPocketCover[r][s]->_( ComboBoxItem( "มน" )); 
                        _pComboPocketCover[r][s]->_( ComboBoxItem( "แหลม" )); 
                        _pComboPocketCover[r][s]->_( ComboBoxItem( "ตัดมุม" )); 

                        _pComboPocketCover[r][s]->select_comboboxItem( 0 ); 
                    }
                }
            }
            _nPocketCover++;
            ...
            if( pocket_level != -1 && pocket_side != -1 && pocketcover_type != -1 ) {
                ...
                _vPocketCoverTreeItems[pocket_level][pocket_side][pocketcover_type] = new_node;
            }                         
        }
            ...
            _pBGComboBox->select_comboboxItem( 1 );  
            ...
            if( nodeName == "แขนกุด" ) {
                ...
                _vSleeveTreeItems[nodeName[0] - 'H'] = new_node;
            }
            ...
            if( _nLen == 0 ) {
                ...
                _pBlouseLengthComboBox->_( ComboBoxItem( "เหนือเข่า" ));
                _pBlouseLengthComboBox->_( ComboBoxItem( "คลุมเข่า" ));
                _nLen += _nLenDress;
            }
            _nLen++;
            ...
            if( nodeName == "เหนือเข่า" ) {
                _vBlouseLengthTreeItems[3] = new_node;
            }
            else if( nodeName == "ความยาวคลุมเข่า" ) {
                _vBlouseLengthTreeItems[4] = new_node;
            }
            ...
            if( _nNeck == 0 ) {
                ...
                _pBlouseNeckComboBox->_( ComboBoxItem( "คอสี่เหลี่ยมแคบ" ));                     
                _pBlouseNeckComboBox->_( ComboBoxItem( "คอคว้านแคบ" ));                     
                _pBlouseNeckComboBox->_( ComboBoxItem( "คอหยดน้ำมีโบว์" ));                     
            }
            SkDebugf( "SetNeck: %i %i\n", n, c );
            _vBlouseNeckTreeItems[n][c] = new_node;

            if( nodeName == "คอกลม" ) {
                _pBlouseNeckComboBox->select_comboboxItem( 0 );
            }            
            _nNeck++;
    ...
    if( pSVGDomEditor ) {
        ...
        if( fDom ) {
            ...
            */
            ...
            _pBlouseLengthComboBox->select_comboboxItem( 0 );
            _pBlouseTypeComboBox->select_comboboxItem( 0 );
            _pBlouseHemComboBox->select_comboboxItem( 0 );
            _pSleeveComboBox->select_comboboxItem( 0 );
            _pCollarComboBox->select_comboboxItem( 0 ); 
            _pHairComboBox->select_comboboxItem( 1 );        
            _pHandComboBox->select_comboboxItem( 1 );  
...
bool DecSVGEditor::__jobExportBG( DecWidget &widget ) {
    ...
    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Background%02i-01.png", __jobExportBGIndex );
...
bool DecSVGEditor::__jobExportHem( DecWidget &widget ) {
    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Base%i%i%i-01.png", 
...
void DecSVGEditor::exportBody() {
    ...
    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Body-01.png");   
    pSVGDomEditor->exportPNG( sz, 150 ); 
}
...
void DecSVGEditor::exportHand() {
    ...
    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Hand-01.png");   
    pSVGDomEditor->exportPNG( sz, 150 ); 
}
...
void DecSVGEditor::exportPant() {
    ...
    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Pant-01.png");   
    pSVGDomEditor->exportPNG( sz, 150 ); 
}
...
bool DecSVGEditor::__jobExportCollar( DecWidget &widget ) {
    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Collar%02i-01.png", __jobExportCollarIndex );
...
bool DecSVGEditor::__jobExportHair( DecWidget &widget ) {
    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Hair%02i-01.png", __jobExportHairIndex );
...
void DecSVGEditor::exportPocketCover() {
    __jobExportPocketLengthIndex = 0;
    __jobExportPocketSideIndex = 0;
    __jobExportPocketTypeIndex = 0;
    ...
    showPocket( 1, 0, 0 );
    showPocket( 1, 1, 0 );      
    showPocketCover( 0, 0, 0 );
    showPocketCover( 0, 1, 0 );
    showPocketCover( 1, 0, 0 );
    showPocketCover( 1, 1, 0 );       
    pushJob( new DecJob([=](DecWidget &w) -> bool {
        return __jobExportPocketCover( w );
    }) ); 
}

void DecSVGEditor::exportPocket() {
    __jobExportPocketLengthIndex = 0;
    __jobExportPocketSideIndex = 0;
    __jobExportPocketTypeIndex = 0;
    ...
    showPocketCover( 1, 1, 0 );         
    pushJob( new DecJob([=](DecWidget &w) -> bool {
        return __jobExportPocket( w );
    }) );       
}

bool DecSVGEditor::__jobExportPocket( DecWidget &widget ) {
    showPocket( 0, 0, 0 );
    showPocket( 0, 1, 0 );
    showPocket( 1, 0, 0 );
    showPocket( 1, 1, 0 );    
    if( __jobExportPocketLengthIndex == 0 ) {
        showPocket( __jobExportPocketLengthIndex, __jobExportPocketSideIndex, __jobExportPocketTypeIndex );
    }
    else {
        _nCurrentBlouseLength = __jobExportPocketLengthIndex;
        showPocket( 1, __jobExportPocketSideIndex, __jobExportPocketTypeIndex );
    }

    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Pocket%i%i%i-01.png", 
        __jobExportPocketLengthIndex, __jobExportPocketSideIndex, __jobExportPocketTypeIndex );
    pSVGDomEditor->exportPNG( sz, 150 );

    __jobExportPocketTypeIndex++;
    if( __jobExportPocketTypeIndex > 10 ) {
        __jobExportPocketTypeIndex = 0;
        __jobExportPocketSideIndex++;


        if( __jobExportPocketSideIndex >= 2 ) {
            __jobExportPocketSideIndex = 0;
            __jobExportPocketLengthIndex++;
            if( __jobExportPocketLengthIndex >= 5 ) {
                return true;
            }
        }
    }
...
bool DecSVGEditor::__jobExportPocketCover( DecWidget &widget ) {
    showPocketCover( 0, 0, 0 );
    showPocketCover( 0, 1, 0 );
    showPocketCover( 1, 0, 0 );
    showPocketCover( 1, 1, 0 );    
    if( __jobExportPocketLengthIndex == 0 ) {
        showPocketCover( __jobExportPocketLengthIndex, __jobExportPocketSideIndex, __jobExportPocketTypeIndex );
    }
    else {
        _nCurrentBlouseLength = __jobExportPocketLengthIndex;
        showPocketCover( 1, __jobExportPocketSideIndex, __jobExportPocketTypeIndex );
    }

    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/PocketCover%i%i%i-01.png", 
        __jobExportPocketLengthIndex, __jobExportPocketSideIndex, __jobExportPocketTypeIndex );
    pSVGDomEditor->exportPNG( sz, 150 );

    __jobExportPocketTypeIndex++;
    if( __jobExportPocketTypeIndex > 4 ) {
        __jobExportPocketTypeIndex = 0;
        __jobExportPocketSideIndex++;
...
bool DecSVGEditor::__jobExportBlouseBody( DecWidget &widget ) {
    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Shirt%i%i%i-01.png", 
    ...
    if( __jobExportBlouseBodyNeckIndex > 7 || (__jobExportBlouseBodyNeckIndex > 6 && __jobExportBlouseBodyTypeIndex == 1) ) {
        __jobExportBlouseBodyNeckIndex = 0;
        __jobExportBlouseBodyTypeIndex++;
        if( __jobExportBlouseBodyTypeIndex > 1 ) {
            __jobExportBlouseBodyTypeIndex = 0;
            __jobExportBlouseBodyLengthIndex++;
            if( __jobExportBlouseBodyLengthIndex > 4 ) {
                return true;
            }
        }
    }
...
bool DecSVGEditor::__jobExportSleeve( DecWidget &widget ) {
    char sz[128];
    sprintf( sz, "resources/_magic_pattern2/Sleeve%02i-01.png", __jobExportSleeveIndex );

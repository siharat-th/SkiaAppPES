...
protected:  
    ...
    DecComboBox *_pComboPocket[2][2];
    DecComboBox *_pComboPocketCover[2][2];

    DecTreeItem *_vPocketTreeItems[5][2][11];
    DecTreeItem *_vPocketCoverTreeItems[5][2][5];

    sk_sp<SkSVGDOM> fDom;
    SkSVGSVG *root;  

    void showPocket( int level, int side, int type );
    void showPocketCover( int level, int side, int type );

    int _nPocket;
    int _nPocketCover;

    int _nPocketType[2][2];
    int _nPocketCoverType[2][2];

    // Background
    int _nBG;
    int _nCurrentBG;
    DecTreeItem *_vBGTreeItems[10];
    ...
    DecTreeItem *_vBlouseLengthTreeItems[5];
    ...
    DecTreeItem *_vBlouseNeckTreeItems[6][8];
    ...
    void exportPocket();
    int __jobExportPocketLengthIndex;
    int __jobExportPocketSideIndex;
    int __jobExportPocketTypeIndex;
    bool __jobExportPocket( DecWidget &widget );    
    bool __jobExportPocketCover( DecWidget &widget );    

    void exportPocketCover();

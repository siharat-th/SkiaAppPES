...
public:    
    ...
    void setSelectedNode(SkSVGNode*pNode);
protected:  
    ...
    DecTabBar *pPropertyTabBar;
    DecColumnContainer *pStrokePropertyBox;
    DecColumnContainer *pFillPropertyBox;
    DecColumnContainer *pExtraPropertyBox;

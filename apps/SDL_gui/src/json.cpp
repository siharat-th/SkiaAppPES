...
class basic_json
{
  ...
  public:
    ...
    */
               ...
               value_t manual_type = value_t::array)
    {
        ...
        if (not type_deduction)
        {
            ...
            {
                return; //throw std::domain_error("cannot create object from initializer list");
            }
        }
    ...
    */
    ...
    basic_json(InputIT first, InputIT last) : m_type(first.m_object->m_type)
    {
        ...
        {
            return; //throw std::domain_error("iterators are not compatible");
        }
        ...
        switch (m_type)
        {
            ...
            case value_t::string:
            {
                ...
                {
                    return; //throw std::out_of_range("iterators out of range");
                }
                break;
            }
        ...
        switch (m_type)
        {
            ...
            {
                assert(first.m_object != nullptr);
                return; //throw std::domain_error("cannot use construct with iterators from " + first.m_object->type_name());
            }
        }
    }
  ...
  private:
    ...
    T get_impl(T*) const
    {
        ...
        {
            return; //throw std::domain_error("type must be object, but is " + type_name());
        }
    }
    ...
    T get_impl(T*) const
    {
        ...
        {
            return; //throw std::domain_error("type must be array, but is " + type_name());
        }
    }
    ...
    T get_impl(T*) const
    {
        ...
        {
            return; //throw std::domain_error("type must be string, but is " + type_name());
        }
    }
    ...
    T get_impl(T*) const
    {
        switch (m_type)
        {
            ...
            default:
            {
                return; //throw std::domain_error("type must be number, but is " + type_name());
            }
        }
    }
    ...
    constexpr boolean_t get_impl(boolean_t*) const
    {
        return is_boolean()
               ? m_value.boolean
        : false; //throw std::domain_error("type must be boolean, but is " + type_name());
    }
    ...
    */
    ...
    static ReferenceType get_ref_impl(ThisType& obj)
    {
        ...
        {
            return; //throw std::domain_error("incompatible ReferenceType for get_ref, actual type is " + obj.type_name());
        }
    }
...
//                return; //throw std::out_of_range("array index " + std::to_string(idx) + " is out of range");
//            }
        }
        else
        {
            return; //throw std::domain_error("cannot use at() with " + type_name());
        }
    }
...
//            {
//                // create better exception explanation
//                return; //throw std::out_of_range("key '" + key + "' not found");
//            }
        }
        else
        {
    ...
    */
    reference operator[](size_type idx)
    {
        ...
        {
            return; //throw std::domain_error("cannot use operator[] with " + type_name());
        }
    }
    ...
    */
    ...
    ValueType value(const typename object_t::key_type& key, ValueType default_value) const
    {
        ...
        {
            return; //throw std::domain_error("cannot use value() with " + type_name());
        }
    }
    ...
    */
    ...
    InteratorType erase(InteratorType pos)
    {
        ...
        {
            return; //throw std::domain_error("iterator does not fit current value");
        }
        ...
        switch (m_type)
        {
            ...
            case value_t::string:
            {
                ...
                {
                    return; //throw std::out_of_range("iterator out of range");
                }
            ...
            default:
            {
                return; //throw std::domain_error("cannot use erase() with " + type_name());
            }
        }
    ...
    */
    ...
    InteratorType erase(InteratorType first, InteratorType last)
    {
        ...
        {
            return; //throw std::domain_error("iterators do not fit current value");
        }
    ...
    */
    void erase(const size_type idx)
    {
        ...
        if (is_array())
        {
            if (idx >= size())
            {
                return; //throw std::out_of_range("index out of range");
            }
  ...
  public:
    ...
    */
    void push_back(basic_json&& val)
    {
        ...
        {
            return; //throw std::domain_error("cannot use push_back() with " + type_name());
        }
    ...
    */
    iterator insert(const_iterator pos, const basic_json& val)
    {
        ...
        {
            return; //throw std::domain_error("cannot use insert() with " + type_name());
        }
    }
    ...
    */
    iterator insert(const_iterator pos, const_iterator first, const_iterator last)
    {
        ...
        if (first.m_object != last.m_object)
        {
            return; //throw std::domain_error("iterators do not fit");
        }

        if (first.m_object == this or last.m_object == this)
        {
            return; //throw std::domain_error("passed iterators may not belong to container");
        }
    ...
    */
    void swap(array_t& other)
    {
        ...
        {
            return; //throw std::domain_error("cannot use swap() with " + type_name());
        }
    }
      ...
      public:
        ...
        reference operator*() const
        {
            ...
            switch (m_object->m_type)
            {
                ...
                case basic_json::value_t::null:
                {
                    return; //throw std::out_of_range("cannot get value");
                }
        ...
        bool operator==(const const_iterator& other) const
        {
            ...
            {
                return; //throw std::domain_error("cannot compare iterators of different containers");
            }
        ...
        bool operator<(const const_iterator& other) const
        {
            ...
            switch (m_object->m_type)
            {
                case basic_json::value_t::object:
                {
                    return; //throw std::domain_error("cannot compare order of object iterators");
                }
        ...
        const_iterator& operator+=(difference_type i)
        {
            ...
            switch (m_object->m_type)
            {
                case basic_json::value_t::object:
                {
                    return; //throw std::domain_error("cannot use offsets with object iterators");
                }
        ...
        reference operator[](difference_type n) const
        {
            ...
            switch (m_object->m_type)
            {
                case basic_json::value_t::object:
                {
                    return; //throw std::domain_error("cannot use operator[] for object iterators");
                }
        ...
        typename object_t::key_type key() const
        {
            ...
            {
                return; //throw std::domain_error("cannot use key() for non-object iterators");
            }
        }
        ...
        */
                                   ...
                                   const std::size_t codepoint2 = 0)
        {
            ...
            if (codepoint1 >= 0xD800 and codepoint1 <= 0xDBFF)
            {
                ...
                {
                    return; //throw std::invalid_argument("missing or wrong low surrogate");
                }
            }
            ...
            {
                return; //throw std::out_of_range("code points above 0x10FFFF are invalid");
            }
                    ...
                    switch (*i)
                    {
                        ...
                        case 'u':
                        {
                            ...
                            if (codepoint >= 0xD800 and codepoint <= 0xDBFF)
                            {
                                ...
                                {
                                    return; //throw std::invalid_argument("missing low surrogate");
                                }
        ...
        */
        void get_number(basic_json& result) const
        {
            ...
            if (result.m_type  == value_t::number_float)
            {
                ...
                {
                    return; //throw std::invalid_argument(std::string("parse error - ") + get_token() + " is not a number");
                }
            }
        }
      ...
      private:
        ...
        void expect(typename lexer::token_type t) const
        {
            if (t != last_token)
            {
                ...
                return; //throw std::invalid_argument(error_msg);
            }
        }
